...
DCBSData = collections.namedtuple('DCBSData', ['obs_density', 'width', 'height', 'num_agents', 'timeout', 'runtimes', 'hlnex', 'llnex',])
ACBSData = collections.namedtuple('ACBSData', ['obs_density', 'width', 'height', 'num_agents', 'timeout', 'runtimes', 'ratios',])
CostsNRWCBSData = collections.namedtuple('CostsNRWCBSData', ['obs_density', 'width', 'height', 'num_agents', 'timeout', 'runtimes', 'ratios', 'costs',])
...
IndData = collections.namedtuple('IndData', ['obs_density', 'width', 'height', 'num_agents','ind_cost',])
