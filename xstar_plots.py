...
min_time = 1/100 #operator_time([xstar_supp_agents_first_times_density_01, xstar_supp_agents_first_times_density_05, xstar_supp_agents_first_times_density_1], min)
max_time = 100 #operator_time([xstar_supp_agents_first_times_density_01, xstar_supp_agents_first_times_density_05, xstar_supp_agents_first_times_density_1], max) * 2
