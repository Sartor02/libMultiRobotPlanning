...
plt_95_ci(cbs_agents_times_density_01, "CBS First/Opt.", 2, 4, 1200, False)
ps.grid()
ps.legend('br')
...
ps.setupfig(thirdsize=True)
plt_95_ci(xstar_agents_first_times_density_01, "X* First", 0, 4, 1200, False)
plt_95_ci(mstar_agents_times_density_01, "M* First/Opt.", 3, 4, 1200, False)
ps.grid()
ps.legend('br')
...
plt_bw(xstar_agents_first_times_density_05, "X* First", 0, 4, 1200, True, 0)
plt_bw(afs_agents_first_times_density_05, "AFS First", 1, 4, 1200, True, 1)
ps.grid()
ps.legend('br')
...
ps.setupfig(thirdsize=True)
plt_95_ci(xstar_agents_first_times_density_05, "X* First", 0, 4, 1200, False)
plt_95_ci(cbs_agents_times_density_05, "CBS First/Opt.", 2, 4, 1200, False)
ps.grid()
ps.legend('br')
...
ps.setupfig(thirdsize=True)
draw_timeout_data(1200, xstar_agents_first_times_density_05)
plt_bw(xstar_agents_first_times_density_05, "X* First", 0, 4, 1200, False, 0)
plt_bw(cbs_agents_times_density_05, "CBS First/Opt.", 2, 4, 1200, False, 1)
ps.grid()
ps.legend('br')
...
ps.setupfig(thirdsize=True)
plt_95_ci(xstar_agents_first_times_density_05, "X* First", 0, 4, 1200, False)
plt_95_ci(mstar_agents_times_density_05, "M* First/Opt.", 3, 4, 1200, False)
ps.grid()
ps.legend('br')
...
draw_timeout_data(1200, xstar_agents_first_times_density_05)
plt_bw(xstar_agents_first_times_density_05, "X* First", 0, 4, 1200, False, 0)
plt_bw(mstar_agents_times_density_05, "M* First/Opt.", 3, 4, 1200, False, 1)
ps.grid()
ps.legend('br')
...
ps.setupfig(thirdsize=True)
plt_95_ci(xstar_agents_first_times_density_1, "X* First", 0, 4, 1200)
plt_95_ci(afs_agents_first_times_density_1, "AFS First", 1, 4, 1200)
ps.grid()
ps.legend('br')
...
plt_bw(xstar_agents_first_times_density_1, "X* First", 0, 4, 1200, True, 0)
plt_bw(afs_agents_first_times_density_1, "AFS First", 1, 4, 1200, True, 1)
ps.grid()
ps.legend('br')
...
ps.setupfig(thirdsize=True)
plt_95_ci(xstar_agents_first_times_density_1, "X* First", 0, 4, 1200, False)
plt_95_ci(cbs_agents_times_density_1, "CBS First/Opt.", 2, 4, 1200, False)
ps.grid()
ps.legend('br')
...
ps.setupfig(thirdsize=True)
draw_timeout_data(1200, xstar_agents_first_times_density_1)
plt_bw(xstar_agents_first_times_density_1, "X* First", 0, 4, 1200, False, 0)
plt_bw(cbs_agents_times_density_1, "CBS First/Opt.", 2, 4, 1200, False, 1)
ps.grid()
ps.legend('br')
...
ps.setupfig(thirdsize=True)
plt_95_ci(xstar_agents_first_times_density_1, "X* First", 0, 4, 1200, False)
plt_95_ci(mstar_agents_times_density_1, "M* First/Opt.", 3, 4, 1200, False)
ps.grid()
ps.legend('br')
...
draw_timeout_data(1200, xstar_agents_first_times_density_1)
plt_bw(xstar_agents_first_times_density_1, "X* First", 0, 4, 1200, False, 0)
plt_bw(mstar_agents_times_density_1, "M* First/Opt.", 3, 4, 1200, False, 1)
ps.grid()
ps.legend('br')
...
# plt_95_ci(xstar_agents_first_times_density_1, "X* First", 0, 4, 1200)
# plt_95_ci(afs_agents_first_times_density_1, "AFS First", 1, 4, 1200)
# plt_95_ci(cbs_agents_times_density_1, "CBS First/Opt.", 2, 4, 1200)
# plt_95_ci(mstar_agents_times_density_1, "M* First/Opt.", 3, 4, 1200)
# ps.grid()
# ps.legend('br')
...
def plt_window_agents_hist(num_agents_in_window_times_lst, title, plt=plt, draw_y_label=True, xlabel="Largest number of\nagents in window"):
    ...
    ks, vs = zip(*k_vs)
    plt.bar(ks, vs, color=ps.color(0, 1))
...
plt_95_ci(afs_agents_first_times_density_const, "AFS First", 1, 4, 1200)
ps.grid()
ps.legend('br')
...
ps.setupfig(thirdsize=True)
plt_95_ci(xstar_agents_first_times_density_const, "X* First", 0, 4, 1200, False)
plt_95_ci(cbs_agents_times_density_const, "CBS First/Opt.", 2, 4, 1200, False)
ps.grid()
ps.legend('br')
...
ps.setupfig(thirdsize=True)
plt_95_ci(xstar_agents_first_times_density_const, "X* First", 0, 4, 1200, False)
plt_95_ci(mstar_agents_times_density_const, "M* First/Opt.", 3, 4, 1200, False)
ps.grid()
ps.legend('br')
...
plt_95_ci(xstar_agents_first_times_density_const, "X* First", 0, 4, 1200)
plt_95_ci(afs_agents_first_times_density_const, "AFS First", 1, 4, 1200)
plt_95_ci(cbs_agents_times_density_const, "CBS First/Opt.", 2, 4, 1200)
plt_95_ci(mstar_agents_times_density_const, "M* First/Opt.", 3, 4, 1200)
ps.grid()
ps.legend('br')
